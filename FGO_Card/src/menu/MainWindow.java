...
public class MainWindow extends JFrame {
	...
	private final MediaPlayer menuBGM = new MediaPlayer(
	...
	private final RoundedTextField upgradeText = new RoundedTextField(15); // for show the upgrade needed of character
																			// or skill
	...
	private static String upgradeString[] = { "100Gold->LV.2", "200Gold->LV.3", "500Gold->LV.4", "1000Gold->LV.MAX",
			"No Upgrade" };
	...
	public void InitialPage() {
		...
		// Initial gameover icon
		gameOverButton.setIcon(new ImageIcon(MainWindow.class.getResource("/image/Game_Over.jpg")));
		gameOverButton.setBounds(0, 0, 480, 720);
	...
	private void LoadData() {
		try {
			BufferedReader br = new BufferedReader(
					new InputStreamReader(MainWindow.class.getResourceAsStream("/SaveData/savedata.data")));
	...
	private void SaveData() {
		try {
			...
			try {
				pw = new PrintWriter(
						new File(MainWindow.class.getResource("/SaveData/savedata.data").toURI().getPath()));
				System.out.println("file open ok");
				pw.println("character:1/" + ChooseCharacter.getLevel(1) + " 2/" + ChooseCharacter.getLevel(2) + " 3/"
						+ ChooseCharacter.getLevel(3));
				pw.println("skill:1/" + ChooseSkill.getSkillLevel(1) + " 2/" + ChooseSkill.getSkillLevel(2) + " 3/"
						+ ChooseSkill.getSkillLevel(3) + " 4/" + ChooseSkill.getSkillLevel(4) + " 5/"
						+ ChooseSkill.getSkillLevel(5));
				pw.println("character_chosen:" + ChooseCharacter.getChosenID());
				pw.println("skill_chosen:" + ChooseSkill.getChooseID(0) + " " + ChooseSkill.getChooseID(1) + " "
						+ ChooseSkill.getChooseID(2));
